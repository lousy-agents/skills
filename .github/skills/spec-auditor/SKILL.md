...
3. If shell access and Python are available, optionally run `./scripts/spec_audit_lint.py <spec-file> --format markdown` for structural findings. Treat script output as a supplement, not the complete audit.
